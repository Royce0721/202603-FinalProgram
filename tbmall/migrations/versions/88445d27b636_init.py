...
Revision ID: 88445d27b636
Revises: 
Create Date: 2025-12-25 03:17:31.040034
...
def upgrade():
    ...
    with op.batch_alter_table('product', schema=None) as batch_op:
        batch_op.create_index('idx_shop_id', ['shop_id'], unique=False)
    ...
    with op.batch_alter_table('favorite_product', schema=None) as batch_op:
...
def downgrade():
    ...
    with op.batch_alter_table('product', schema=None) as batch_op:
        batch_op.drop_index('idx_shop_id')
